...
DecodeResult& SparcDecoder::decodeAssembly (ADDRESS pc, std::string line)
{
  ...
  if (tokens.at(0) == "AND" || tokens.at(0) == "MOV" || tokens.at(0) == "ANDcc" || tokens.at(0) == "ANDN" || tokens.at(0) == "ANDNcc" || tokens.at(0) == "OR" || tokens.at(0) == "ORcc" || tokens.at(0) == "ORN" || tokens.at(0) == "ORNcc" || tokens.at(0) == "XOR" || tokens.at(0) == "XORcc" || tokens.at(0) == "XNOR" || tokens.at(0) == "XNORcc" || tokens.at(0) == "SLL" || tokens.at(0) == "SRL" || tokens.at(0) == "SRA" || tokens.at(0) == "ADD" || tokens.at(0) == "ADDcc" || tokens.at(0) == "ADDX" || tokens.at(0) == "ADDXcc" || tokens.at(0) == "TADDcc" || tokens.at(0) == "TADDccTV" || tokens.at(0) == "SUB" || tokens.at(0) == "SUBcc" || tokens.at(0) == "SUBX" || tokens.at(0) == "SUBXcc" || tokens.at(0) == "TSUBcc" || tokens.at(0) == "TSUBccTV" || tokens.at(0) == "MULScc" || tokens.at(0) == "UMUL" || tokens.at(0) == "SMUL" || tokens.at(0) == "UMULcc" || tokens.at(0) == "SMULcc" || tokens.at(0) == "UDIV" || tokens.at(0) == "SDIV" || tokens.at(0) == "UDIVcc" || tokens.at(0) == "SDIVcc" || tokens.at(0) == "SAVE") {
    if (tokens.at(0) == "MOV"){
